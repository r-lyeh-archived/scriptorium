...
routines) is copyright (c) 1997-2012 by ITB CompuPhase, and distributed under
the "Apache License" version 2.0, which is reproduced below, plus an exception
clause regarding static linking. See the file NOTICES for contributions and
...
The Pawn documentation is copyright (c) 1997--2012 by ITB CompuPhase, and
licensed under the Creative Commons Attribution/Share-Alike 3.0 License. To
view a copy of this licence, visit http://creativecommons.org/licenses/by-sa/3.0/
or send a letter to Creative Commons, 559 Nathan Abbott Way, Stanford,
California 94305, USA. Below is a "human-readable" summary of the Legal Code
(the full licence).
