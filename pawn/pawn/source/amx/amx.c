...
#ifndef AMX_JIT_CALLCONV
#define AMX_JIT_CALLCONV __cdecl
#endif
     ...
     */
      ...
      extern cell AMX_JIT_CALLCONV amx_exec_run(AMX *amx,cell *retval,unsigned char *data);
      extern int  AMX_JIT_CALLCONV amx_exec_list(const AMX *amx,const cell **opcodelist,int *numopcodes);
      extern cell AMX_JIT_CALLCONV amx_jit_compile(void *pcode, void *jumparray, void *nativecode);
      extern cell AMX_JIT_CALLCONV amx_jit_run(AMX *amx,cell *retval,unsigned char *data);
      extern int  AMX_JIT_CALLCONV amx_jit_list(const AMX *amx,const cell **opcodelist,int *numopcodes);
    #endif
  #else /* __WIN32__ */
