...
-newthread and sq_newthread() no longer resets the base lib function in the root table(thx Lucas Cardellini)
...
-fixed compiler bug that can cause memory corruption, the bug was introduced in 3.0.5(thx Alex95)

***2014-03-22		   ***
***version 3.0.5 stable***
-fixed crash in compiler when trying to write 'base'
-fixed bug in gc
-fixed few bugs in the compiler
